                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="name" value="{{ $patients->getTranslation('name', 'ar') }}" class="form-control" required>
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="name_en" value="{{ $patients->getTranslation('name', 'en') }}" class="form-control" required>
                                 <span class="help-block with-errors"></span>
                              </div>
                            </div>
                            <div class="col-md-4">
                          ...
                          <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="date" name="joining_date" value="{{ $patients->joining_date }}" class="form-control" required>
                                <span class="help-block with-errors"></span>
                              </div>
                            </div>
                        </div>
